...
## Create the NYCTaxiData-Curated Container on Azure Data Lake Storage Gen2
In this section you will create a container in your SynapseDataLake that will be used as a repository for curated Parquet files for the Spark table that will be generated by your Databricks notebook. These files contain cleansed and validated data ready to be used for reporting.
